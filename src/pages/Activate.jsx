...
const Activate = () => {
  ...
  return (
    <>
      <div className="flex items-center justify-between px-6 md:px-[200px] py-4 bg-teal-600 text-white">
        <h1 className="text-lg md:text-xl font-extrabold">Travel Planner</h1>
      </div>
